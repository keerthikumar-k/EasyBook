  ...
  const getMoviesByLocation = (city) => {
    ...
    if (tamilNaduCities.includes(city)) {
      return [
        ...
        { id: 3, title: 'PS1 - Ponniyan Selvan', genre: 'Drama', language: 'Tamil', rating: 8.5, poster: '/src/images/ps1.jpg', duration: 167, description: 'Historical drama', showtimes: [{theater: 'PVR Cinemas', time: '6:30 PM', price: 220}] },
        ...
        { id: 7, title: 'Leo', genre: 'Action', language: 'Tamil', rating: 8.3, poster: '/src/images/leo.webp', duration: 164, description: 'Action thriller', showtimes: [{theater: 'Kamala Cinemas', time: '6:00 PM', price: 200}] },
        { id: 8, title: 'Kaithi', genre: 'Action', language: 'Tamil', rating: 8.4, poster: '/src/images/kaithi.webp', duration: 145, description: 'Action thriller', showtimes: [{theater: 'Luxe Cinemas', time: '9:30 PM', price: 250}] }
      ];
    } else {
      return [
